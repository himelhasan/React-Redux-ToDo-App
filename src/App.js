...
import notes from "../src/html_template/images/notes.png";
import doubleTick from "../src/html_template/images/double-tick.png";
import cancel from "../src/html_template/images/cancel.png";
import plus from "../src/html_template/images/plus.png";
        ...
        <div class="w-full max-w-3xl shadow-lg rounded-lg p-6 bg-white">
          ...
          <div class="mt-2 text-gray-700 text-sm max-h-[300px] overflow-y-auto">
            ...
            <div class="flex justify-start items-center p-2 hover:bg-gray-100 hover:transition-all space-x-4 border-b border-gray-400/20 last:border-0">
              ...
              <div class="flex-shrink-0 h-4 w-4 rounded-full bor der-2 ml-auto cursor-pointer border-red-500 hover:bg-red-500"></div>
